 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "        w = [[random.choice([0,1]) for j in range(0,2)] for i in range(wire_count+1)]\n",
    "        # assign values.\n",
    "        self.w = w\n",
    "    \n",
    ...
    "                entry = {'id': gate['id'], 'inputs' : [], 'outputs':[], 'input_description':potentialInput}\n",
    "                for i in range(len(gate['in'])):\n",
    "                    entry['inputs'].append({\n",
    "                                  'wire':   gate['in'][i], \n",
    ...
    "        outputDecryptionBit = p[self.out]\n",
    "        \n",
    "        return {\n",
    "            'table'  : garbled,\n",
    "            'w'      : w,\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "{'outputs': [{'encryptedValue': 1, 'wire': 3}], 'input_description': [0, 0], 'id': 3, 'inputs': [{'encryptedValue': 0, 'wire': 1}, {'encryptedValue': 0, 'wire': 2}]}\n",
      "{'outputs': [{'encryptedValue': 1, 'wire': 3}], 'input_description': [0, 1], 'id': 3, 'inputs': [{'encryptedValue': 0, 'wire': 1}, {'encryptedValue': 0, 'wire': 2}]}\n",
      "{'outputs': [{'encryptedValue': 1, 'wire': 3}], 'input_description': [1, 0], 'id': 3, 'inputs': [{'encryptedValue': 1, 'wire': 1}, {'encryptedValue': 0, 'wire': 2}]}\n",
      "{'outputs': [{'encryptedValue': 1, 'wire': 3}], 'input_description': [1, 1], 'id': 3, 'inputs': [{'encryptedValue': 1, 'wire': 1}, {'encryptedValue': 0, 'wire': 2}]}\n",
      "[[1, 0], [1, 1], [0, 1], [0, 0]]\n",
      "[0, 1, 0, 1]\n"
     ]
    }
